...
class BaseController extends AbstractController
{
    ...
    #[Route('/liste-cadurciens', name: 'app_cadurciens')]
    ...
    #[Route('/liste-utilisateurs', name: 'app_utilisateurs')]
    ...
    #[Route('/liste-frais', name: 'app_frais')]
    ...
    #[Route('/liste-sans-frais', name: 'app_pas_de_frais')]
    ...
    #[Route('/liste-nombre-de-frais', name: 'app_nombre_de_frais')]
